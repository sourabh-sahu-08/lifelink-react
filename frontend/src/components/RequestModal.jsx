                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    >
                        <div className="bg-red-600 p-8 text-white relative">
                            <h2 className="text-3xl font-bold uppercase tracking-tight">Create Request</h2>
                            <p className="text-red-100 text-xs font-semibold uppercase tracking-widest mt-1 opacity-80">Emergency Blood Broadcast</p>
                        ...
                        <form onSubmit={handleSubmit} className="p-8 space-y-6">
                            <div>
                                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-3">Target Blood Type</label>
                                <div className="grid grid-cols-4 gap-3">
                                    {bloodTypes.map(type => (
                                        <button
                                            ...
                                            className={`py-3 rounded-xl border-2 font-semibold text-sm transition-all ${formData.bloodType === type ? 'border-red-600 bg-red-50 text-red-600 shadow-md' : 'border-gray-100 text-gray-400 hover:border-gray-200 hover:bg-gray-50'}`}
                                        >
                                            {type}
                                        </button>
                                    ))}
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-3">Units Required</label>
                                    <div className="flex items-center space-x-4 bg-gray-50 p-2 rounded-2xl border border-gray-100">
                                        ...
                                        <span className="flex-1 text-center font-bold text-xl text-gray-900 leading-none">{formData.units}</span>
                                        <button
                                            type="button"
                                ...
                                <div>
                                    <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-3">Urgency Level</label>
                                    <select
                            ...
                            <div>
                                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-3">Reason / Diagnosis</label>
                                <textarea
